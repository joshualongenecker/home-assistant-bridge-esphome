...
static void publish_sub_topic(i_mqtt_client_t* self, const char* sub_topic, const char* payload)
{
  mock()
    .actualCall("publish_sub_topic")
    .onObject(self)
    .withParameter("sub_topic", sub_topic)
