...
def load_appliance_types():
    ...
    if esphome_cache_path not in [p[1] for p in search_paths]:
    ...
    if config_esphome_cache_path not in [p[1] for p in search_paths]:
    ...
    if build_cache_path not in [p[1] for p in search_paths]:
