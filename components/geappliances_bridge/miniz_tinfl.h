...
{
#endif
    /* Decompression flags used by gea_tinfl_decompress(). */
    ...
    /* The tinfl_decompress and tinfl_decompress_mem_to_* functions in this component carry a gea_ prefix instead of
